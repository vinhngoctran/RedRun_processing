...
axes1 = axes('Parent',figure1,...
    'Position',[0.05 0.3 0.3 0.5]);hold on;
for i=1:14
    if i==1
...
legend1 = legend;
set(legend1,...
    'Position',[0.112612617143371 0.601603023050979 0.238175671144917 0.198019796373821],...
...
axes1 = axes('Parent',figure1,...
    'Position',[0.41 0.3 0.5 0.3]);hold on;
% for ii=1:5
for i=1:6
...
set(legend1,...
    'Position',[0.424684684760199 0.326880944895489 0.105574322461679 0.183456398661455]);
...
axes1 = axes('Parent',figure1,...
    'Position',[0.41 0.65 0.5 0.15]);hold on;
Event = 5;
...
exportgraphics(figure1, "Figs/F4_2.pdf", 'ContentType', 'vector');
exportgraphics(figure1,"Figs/F4_2.jpeg",'Resolution',600);
